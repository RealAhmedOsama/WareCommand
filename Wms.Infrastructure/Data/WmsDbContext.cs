...
public class WmsDbContext : IdentityDbContext<WmsUser, IdentityRole, string>
{
    ...
    public DbSet<ShipmentPackageLink> ShipmentPackageLinks => Set<ShipmentPackageLink>();
    ...
    public DbSet<InventoryClassificationPolicy> InventoryClassificationPolicies =>
        Set<InventoryClassificationPolicy>();
    public DbSet<InventoryClassification> InventoryClassifications =>
    ...
    public DbSet<WmsIntegrationOutboxEntity> IntegrationOutbox => Set<WmsIntegrationOutboxEntity>();

    public DbSet<WmsIntegrationInboxEntity> IntegrationInbox => Set<WmsIntegrationInboxEntity>();

    public DbSet<WmsWebhookSubscriptionEntity> WebhookSubscriptions =>
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new CarrierConfiguration());
        builder.ApplyConfiguration(new CarrierServiceConfiguration());
        builder.ApplyConfiguration(new ShipmentConfiguration());
        builder.ApplyConfiguration(new ShipmentLineConfiguration());
        builder.ApplyConfiguration(new ShipmentPackageLinkConfiguration());
        ...
        builder.ApplyConfiguration(new WmsIntegrationOutboxConfiguration());
