...
| #7–#107 | pending | Not yet evaluated as complete | — | Ordered by the master plan and prerequisite constraints | Implement #7 next; preserve the phase order and authoritative issue scope |

## Phase checkpoint

- Phase 0: #2, #3, #4, #5, and #6 committed; #7–#11 pending.
