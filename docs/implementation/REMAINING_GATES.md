...
`c7ee719927eec08e0902d99302cf17ec615a28b8` on 2026-09-26. Receiving
follow-ups `5d0cfd5` and `c7ee719` reuse stock and location reads. Earlier exact-SHA
CI run
...
The latest pushed application-code SHA `c7ee719927eec08e0902d99302cf17ec615a28b8`
reuses the receiving stock snapshot and the tracked, caller-scope-visible
location. Focused stock movement, receiving use case, and repository tests
passed 17/17, 11/11, and 4/4; their combined repository/service suite passed
21/21. Exact-SHA Actions run
[#36193896584](https://github.com/RealAhmedOsama/WareCommand/actions/runs/36193896584)
is running for Linux/Windows quality and coverage, PostgreSQL groups, migration,
Docker, and secret scan; direct-push dependency review is skipped. Separately,
the exact-source local performance profile recorded 20 failing workload/repeat
entries and 35 metric breaches, with clean reconciliation and 11,199/11,214
database-command telemetry samples. CI does not run this performance group or
qualify capacity. See `PERFORMANCE_QUALIFICATION.md` for measurements.

## Current residual register

The latest local performance profile is on `c7ee719`; it recorded 20 failing
workload/repeat entries and 35 metric breaches. The remaining master-plan gates
