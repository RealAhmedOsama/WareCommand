...
release definition. PostgreSQL #130's original qualification recorded 13
scenario reports and 199 reconciliation checkpoints with no unexpected
issues. Its cross-dock follow-up now verifies receipt reservation, idempotent
pick-work creation, replacement of full-quantity putaway with the unmatched
fallback quantity, pick completion from receiving, and the resulting partial
plan status. Other unsupported journey branches remain documented in the #130
