...
$webAssembly = Join-Path $webProject 'bin/Release/net8.0/Wms.ASP.dll'
$winFormsExecutable = Join-Path $repositoryRoot 'Warehouse Management System/bin/Release/net8.0-windows/Wms.WinForms.exe'
